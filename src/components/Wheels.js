    ...
    <div className="bg-gray-100  rounded p-2">
      ...
      <div className="flex flex-row items-center justify-start">
        <input type="radio" id="tyresNo"
          ...
          onChange={props.calculateWheels}
            />
        <label className="cursor-pointer leading-tight sm:leading-normal hover:bg-gray-200" htmlFor="tyresNo">Не учитывать
        </label>
      </div>
      <div className="flex flex-row items-center justify-start">
        <input type="radio" id="tyres"
          ...
          onChange={props.calculateWheels}
            />
        <label className="cursor-pointer leading-tight sm:leading-normal hover:bg-gray-200" htmlFor="tyres">Комплект сезонных Шин
        </label>
      ...
      <div className="flex flex-row items-center justify-start">
        ...
        <input type="radio" id="tyresPlus"
          ...
          onChange={props.calculateWheels}
          />
        <label className="cursor-pointer leading-tight sm:leading-normal hover:bg-gray-200" htmlFor="tyresPlus">Комплект шины с дисками и датчиками
        </label>
