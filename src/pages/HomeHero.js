...
function HomeHero() {
  return(
    <main className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-30">
      <div className="sm:text-center lg:text-left">
        ...
        <p className="mt-3 text-base text-gray-700 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">Ці додаткові витрати включають: <s>амортизацію</s>, <s>відсотки за кредит</s>, податки та збори, страхові внески, витрати на паливо, технічне обслуговування та ремонт. Перегляньте вітрати на володіння будь-яким авто.</p>
        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
          <div className="rounded-md shadow">
            <span className="w-full flex items-center justify-center px-6 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue transition duration-150 ease-in-out md:py-3 md:text-lg md:px-8">
              Перелік авто
            </span>
          </div>
